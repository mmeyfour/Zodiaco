...
let goat = ZodiacSign(name: "Cabra", description: "Pacifico, adaptable, honesto, creativo, imaginativo, sincero", fromYear: 1991, fromMonth: 2, fromDay: 15, toYear: 1992, toMonth: 2, toDay: 3, aspect: "Yin", element: "Metal", firstAfinity: "Cerdo", secondAfinity: "Liebre", animalImage: UIImage(named:"Cabra")!, elementImage: UIImage(named:"Metale")!)
...
let pig = ZodiacSign(name: "Cerdo", description: "Sensual, generoso,alegre, tolerante, feliz, entusiasta", fromYear: 1995, fromMonth: 1, fromDay: 31, toYear: 1996, toMonth: 2, toDay: 16, aspect: "Yin", element: "Madera", firstAfinity: "Conejo", secondAfinity: "Cabra", animalImage: UIImage(named:"Cerdo")!, elementImage: UIImage(named:"Madera")!)
